...
export async function generateMetadata(): Promise<Metadata> {
    const metaData = {
        title: "Thiết Kế - Tiệm Kiến Trúc",
        description: "Khám phá dịch vụ thiết kế kiến trúc và nội thất cao cấp tại Tiệm Kiến Trúc. Chúng tôi mang đến những giải pháp sáng tạo, tối ưu hóa không gian sống theo phong cách riêng của bạn.",
