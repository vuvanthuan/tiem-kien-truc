...
const staticPaths = {
  ...
  '/gioi-thieu/gioi-thieu-doi-ngu-nhan-su': { changefreq: 'monthly', priority: 0.7 },
  '/gioi-thieu/gioi-thieu-quy-trinh-lam-viec': { changefreq: 'monthly', priority: 0.7 },
  '/gioi-thieu/gioi-thieu-ho-so-nang-luc': { changefreq: 'monthly', priority: 0.7 },
};

const initMenu = [
  { label: 'Trang chủ', value: '' },
  { label: 'Giới Thiệu', value: 'gioi-thieu', children: [
  ...
  { label: 'Thiết Kế', value: 'thiet-ke', children: [
    { label: 'Quy hoạch cảnh quan', value: 'quy-hoach-canh-quan' },
    { label: 'Thiết kế Showroom', value: '', children: [
    ...
    { label: 'Thiết kế nhà hàng', value: '', children: [
    ...
    { label: 'Thiết kế khách sạn', value: '', children: [
      { label: 'Thiết kế nội thất khách sạn', value: 'thiet-ke-noi-that-khach-san' },
    ]},
    { label: 'Thiết kế quán cafe', value: '', children: [
  ...
  { label: 'Thi Công', value: 'thi-cong', children: [
    { label: 'Dự án thi công', value: 'du-an-thi-cong' },
  ]},
  { label: 'Báo giá', value: 'bao-gia', children: [
